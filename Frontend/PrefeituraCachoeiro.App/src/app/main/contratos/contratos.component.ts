...
export class ContratosComponent implements AfterViewInit, OnInit {
  ...
  displayedColumns: string[] = ['empresa','numeroContrato','nomePrefeitura', 'dataInicio', 'dataTermino', 'gerente', 'valor','valorTotalMedido', 'valorSaldoRestante','valorSolicitado','tipoContratacao','acoes'];
